...
func SetupRouter(handler *Handler, agentHandler interface{}, frontendFS fs.FS, embedMode, isDebug bool) *gin.Engine {
	...
	api.Use(JWTAuthenticationMiddleware(handler.config, handler.db))
	{
		...
		projects := api.Group("/projects")
		{
			...
			projects.POST("/:id/versions/:vid/pages/:pid/test-cases/:tcid/refine", projectHandlers.RefineTestCase)
			projects.GET("/:id/versions/:vid/pages/:pid/test-cases/:tcid/refinements", projectHandlers.ListTestCaseRefinements)
			projects.GET("/:id/versions/:vid/pages/:pid/test-cases/:tcid/refinements/:rid", projectHandlers.GetTestCaseRefinement)
			projects.POST("/:id/versions/:vid/pages/:pid/test-cases/:tcid/refinements/:rid/apply", projectHandlers.ApplyTestCaseRefinement)
			projects.POST("/:id/versions/:vid/pages/:pid/test-cases/:tcid/refinements/:rid/discard", projectHandlers.DiscardTestCaseRefinement)
