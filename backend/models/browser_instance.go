...
type BrowserInstance struct {
	...
	Name        string `gorm:"size:255;index" json:"name"`   // 实例名称
	Description string `gorm:"type:text" json:"description"` // 实例描述
	IsDefault   bool   `gorm:"index" json:"is_default"`      // 是否为默认实例
	IsActive    bool   `gorm:"index" json:"is_active"`       // 是否正在运行
	...
	LaunchArgs []string `gorm:"type:jsonb;serializer:json" json:"launch_args,omitempty"` // 启动参数
